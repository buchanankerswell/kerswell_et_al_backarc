...
list.files('data/diff_ga', pattern = '.RData', full.names = T) -> fpaths
purrr::map_chr(
...
# theme(plot.title = element_text(hjust = 1), axis.text = element_text(size = 8), legend.position = 'bottom', legend.justification = 'right') -> p1
...
# plot_annotation(tag_levels = 'a') &
# guides(color = guide_colorbar(barwidth = unit(50, 'mm'))) &
# theme(plot.title = element_text(hjust = 1), axis.text = element_text(size = 8), legend.position = 'bottom', legend.justification = 'right') -> p2
...
plot_annotation(tag_levels = 'a') &
guides(color = guide_colorbar(barwidth = unit(50, 'mm'))) &
theme(plot.title = element_text(hjust = 1), axis.text = element_text(size = 8), legend.position = 'bottom', legend.justification = 'right') -> p3
...
# plot_annotation(tag_levels = 'a') &
# guides(color = guide_colorbar(barwidth = unit(50, 'mm'))) &
# theme(plot.title = element_text(hjust = 1), axis.text = element_text(size = 8), legend.position = 'bottom', legend.justification = 'right') -> p4
...
plot_annotation(tag_levels = 'a') &
guides(color = guide_colorbar(barwidth = unit(50, 'mm'))) &
theme(plot.title = element_text(hjust = 1), axis.text = element_text(size = 8), legend.position = 'bottom', legend.justification = 'right') -> p5
