...
Testing hypotheses relating to subduction dynamics and seismicity require sampling of heat flow. Sampling in previous work commonly uses a three-part strategy: 1) draw a cross-section line perpendicular to the trench, 2) draw a rectangle with arbitrary width bisected by the section line, 3) gather all heat flow observations within the rectangle and project them onto the section line. This sampling strategy is simple and most effective for section lines with nearby, equally spaced, high-density observations (almost never the case). The method increasingly violates the First Law as the size of the sampling rectangle increases, including more disparate points. This strategy must also be repeated many times along strike to fully characterize the spatial distribution of heat flow near subduction zone segments. Repeated sampling along strike has not been done in previous studies.
