...
{\centering \includegraphics[width=0.9\linewidth,]{../figs/base/hf_luca} 
...
{\centering \includegraphics[width=0.9\linewidth,]{../figs/hf_summary} 
...
{\centering \includegraphics[width=0.9\linewidth,]{../figs/variogram_summary} 
...
{\centering \includegraphics[width=0.9\linewidth,]{../figs/hf_diff_summary} 
