...
fpath <- list.files('data/diff_byeye', pattern = '.RData', full.names = T)
purrr::map_chr(
  list.files('data/diff_byeye', pattern = '.RData'),
  ~.x %>%
...
ggsave(
  file = 'figs/summary_byeye/hf_summary.png',
  plot = p,
  device = 'png',
  type = 'cairo',
  width = 4,
...
purrr::map_df(fname,
  ...
  mutate(
    ...
    'Range' = round(Range/1000, 1)) -> variogram.summary
...
ggsave(
  file = 'figs/summary_byeye/variogram_summary.png',
  plot = p,
  device = 'png',
  type = 'cairo',
  width = 8,
...
ggsave(
  file = 'figs/summary_byeye/hf_diff_summary.png',
  plot = p,
  device = 'png',
  type = 'cairo',
  width = 4,
